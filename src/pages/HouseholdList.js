...
const HouseholdList = () => {
  ...
  const completedSurveys = households.filter(h => h.status === 'completed').length;
  const pendingSurveys = households.filter(h => h.status === 'pending').length;
  const completionRate = totalHouseholds > 0 ? Math.round((completedSurveys / totalHouseholds) * 100) : 0;
    ...
    <div>
      ...
      <div className="dashboard-stats" style={{ 
        ...
        <div className="stat-card" style={{ 
          ...
          <h3 style={{ color: 'var(--text-light)', fontSize: '0.9rem', margin: '0 0 5px 0', textTransform: 'uppercase', letterSpacing: '1px' }}>
            Total Households
          </h3>
          <p style={{ fontSize: '2rem', fontWeight: '600', margin: '0', color: 'var(--primary-color)' }}>
            {totalHouseholds}
          </p>
        </div>
        ...
        <div className="stat-card" style={{ 
          ...
          <p style={{ fontSize: '2rem', fontWeight: '600', margin: '0', color: 'var(--success-color)' }}>
            {completedSurveys}
          </p>
        </div>
        ...
        <div className="stat-card" style={{ 
          ...
          <p style={{ fontSize: '2rem', fontWeight: '600', margin: '0', color: 'var(--warning-color)' }}>
            {pendingSurveys}
          </p>
        </div>
        ...
        <div className="stat-card" style={{ 
          ...
          <p style={{ fontSize: '2rem', fontWeight: '600', margin: '0', color: '#6c5ce7' }}>
            {completionRate}%
          </p>
          <div style={{ 
            position: 'absolute', 
